<?php 
    ...
    if(isset($_REQUEST['id']) && isset($_REQUEST['id']) != "") {
        $id = $_REQUEST['id'];
        $sql = "select * from can_bo where id = $id";
  ...
  <body>
    <div class="container">
      <div class="form-dang-nhap">
        ...
        <form action="xuly_sua.php?id=<?php echo $id; ?>" method="POST">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input
              ...
              id="sdt_co_quan"
              name="sdt_co_quan"
              value="<?php echo $row['sdt_co_quan']; ?>"
            />
          </div>
          <div class="mb-3">
          ...
          <button type="submit" name="submitEdit" class="btn btn-primary">Cập nhật</button>
        </form>
      </div>
    </div>
